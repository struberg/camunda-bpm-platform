...
public interface TaskQuery extends Query<TaskQuery, Task>{
   ...
   * @param name variable name, cannot be null.
   */
  TaskQuery caseInstanceVariableValueGreaterThanOrEqual(String variableName, Object variableValue);
   ...
   * @param name variable name, cannot be null.
   */
  TaskQuery caseInstanceVariableValueLessThanOrEqual(String variableName, Object variableValue);
